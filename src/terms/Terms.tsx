...
const TermsPage: React.FC = () => {
    ...
    return (
        <section>
            <Helmet>
                <title>VTNE Simplified - Terms of Use</title>
            ...
            <div className="mx-auto w-full max-w-7xl px-5 md:px-10 lg:px-24">
                <div className="flex max-w-3xl flex-col py-16 md:py-24 lg:py-32">
                    ...
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                        ...
                        <p className="text-sm sm:text-base">1.1. VTNE Simplified provides resources and tools to help users prepare for the VTNE exam. <br />1.2. The app and services collect, store, and analyze study-related data to enhance your learning experience. <br />1.3. Specific details about the services will be provided within the app.</p>
                    </div>
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                        <p className="font-bold uppercase sm:text-base">2. Information Collected</p>
                        <p className="text-sm sm:text-base">2.1. When you use VTNE Simplified, we receive some personal information such as your device type and IP address. <br />2.2. Additional optional information includes study preferences, completed practice questions, test scores, and login information from Apple, Google, or Facebook.</p>
                    </div>
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                    ...
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                        ...
                        <p className="text-sm sm:text-base">5.1. We keep your account information for as long as your account is active. <br />5.2. Study data is retained until you delete the data or your account.</p>
                    </div>
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                    ...
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                        ...
                        <p className="text-sm sm:text-base">7.1. VTNE Simplified displays ads through Google's ad network Google AdMob. <br />7.2. You may opt out of personalized ads within your device's settings. No ads will be shown after an in-app purchase.</p>
                    </div>
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                        <p className="font-bold uppercase sm:text-base">8. Social Sharing</p>
                        <p className="text-sm sm:text-base">8.1. If you use the social features of VTNE Simplified, your study progress may be visible to your friends on the app. <br />8.2. You can stop sharing this data at any time by blocking friends or logging out of the app.</p>
                    </div>
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                    ...
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                        ...
                        <p className="text-sm sm:text-base">10.1. VTNE Simplified's services are not directed at persons under the age of 13. <br />10.2. If you are under 13, please do not submit any personal data. If we discover data from a person under 13, we will delete it.</p>
                    </div>
                    <div className="mb-6 flex flex-col items-start gap-y-3">
                    ...
                    <p className="mb-6 text-sm sm:text-base">By accessing and using the VTNE Simplified app, you agree to these terms of service.</p>
                    <p className="text-sm sm:text-base">For further questions, contact us at <a href="mailto:quizifycompany@gmail.com" className="font-bold">quizifycompany@gmail.com</a></p>
                </div>
            </div>
        </section>
    );
